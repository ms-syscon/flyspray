...
class Project
{
	...
	private function _pm_list_sql($type, $join)
	{
		global $db;
	...
	*/
	private function _list_sql($type, $where = null)
	{
		// sanity check
		if (preg_match('![^A-Za-z0-9_]!', $type)) {
			return '';
